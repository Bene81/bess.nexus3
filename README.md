...
This class library offers functionality allowing you to use and access the Nexus Repository OSS 3 REST API.

It was generated using the `swagger.json` file provided by Nexus Repository OSS 3.30.1-01 server which can be found [here](https://github.com/sonatype/nexus-public).
To obtain the JSON scheme refer to the [NEXUS Repository OSS 3 documentation](https://help.sonatype.com/repomanager3/rest-and-integration-api).
...
- use Basic Authentication when `Username` and `Password` were set at the `ApiClient`'s `Configuration` property.
...
You can either obtain corresponding nuget package or build the client yourself.
To obtain the package from nuget.org call
...
```sh
git clone https://github.com/Bene81/nexu3client.git
...
namespace Example
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // authentication from/in untrusted networks.
