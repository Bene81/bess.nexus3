...
namespace Bess.IO.Rest.Nexus3.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Bess.IO.Rest.Nexus3.Client.Configuration.Default;
            RestClient = new RestClient("https://localhost/service/rest/");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://localhost/service/rest/).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Bess.IO.Rest.Nexus3.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://localhost/service/rest/")
        {
