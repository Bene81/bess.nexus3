...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BowerProxyApiRepository :  IEquatable<BowerProxyApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BowerProxyApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BowerProxyApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BowerProxyApiRepository" /> class.
        /// </summary>
        ...
        public BowerProxyApiRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string), BowerAttributes bower = default(BowerAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for BowerProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for BowerProxyApiRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for BowerProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for BowerProxyApiRepository and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BowerProxyApiRepository);
        }

        /// <summary>
        /// Returns true if BowerProxyApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of BowerProxyApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BowerProxyApiRepository input)
        {
            if (input == null)
                return false;
