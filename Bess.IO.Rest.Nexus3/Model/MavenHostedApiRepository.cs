...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MavenHostedApiRepository :  IEquatable<MavenHostedApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenHostedApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MavenHostedApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenHostedApiRepository" /> class.
        /// </summary>
        ...
        public MavenHostedApiRepository(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes), MavenAttributes maven = default(MavenAttributes))
        {
            // to ensure "online" is required (not null)
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for MavenHostedApiRepository and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for MavenHostedApiRepository and cannot be null");
            }
            else
            {
            ...
            if (maven == null)
            {
                throw new InvalidDataException("maven is a required property for MavenHostedApiRepository and cannot be null");
            }
            else
            {
                this.Maven = maven;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MavenHostedApiRepository {\n");
        ...
        {
            return this.Equals(input as MavenHostedApiRepository);
        }

        /// <summary>
        /// Returns true if MavenHostedApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of MavenHostedApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MavenHostedApiRepository input)
        {
            if (input == null)
                return false;
