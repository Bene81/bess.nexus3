...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DockerHostedRepositoryApiRequest :  IEquatable<DockerHostedRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerHostedRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DockerHostedRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerHostedRepositoryApiRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DockerHostedRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if DockerHostedRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DockerHostedRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DockerHostedRepositoryApiRequest input)
        {
            if (input == null)
                return false;
