...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MavenProxyRepositoryApiRequest :  IEquatable<MavenProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MavenProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public HttpClientAttributesWithPreemptiveAuth HttpClient { get; set; }
        ...
        {
            return this.Equals(input as MavenProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if MavenProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MavenProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MavenProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
