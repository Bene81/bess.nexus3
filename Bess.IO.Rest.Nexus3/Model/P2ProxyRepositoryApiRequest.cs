...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2ProxyRepositoryApiRequest :  IEquatable<P2ProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="P2ProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected P2ProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="P2ProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public P2ProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for P2ProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as P2ProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if P2ProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of P2ProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2ProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
