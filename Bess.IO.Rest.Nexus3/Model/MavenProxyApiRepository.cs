...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MavenProxyApiRepository :  IEquatable<MavenProxyApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenProxyApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MavenProxyApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MavenProxyApiRepository" /> class.
        /// </summary>
        ...
        public MavenProxyApiRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string), MavenAttributes maven = default(MavenAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for MavenProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for MavenProxyApiRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for MavenProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for MavenProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (maven == null)
            {
                throw new InvalidDataException("maven is a required property for MavenProxyApiRepository and cannot be null");
            }
            else
            {
                this.Maven = maven;
        ...
        /// Gets or Sets Maven
        /// </summary>
        [DataMember(Name="maven", EmitDefaultValue=false)]
        public MavenAttributes Maven { get; set; }
        ...
        {
            return this.Equals(input as MavenProxyApiRepository);
        }

        /// <summary>
        /// Returns true if MavenProxyApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of MavenProxyApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MavenProxyApiRepository input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Maven == input.Maven ||
                    (this.Maven != null &&
                    this.Maven.Equals(input.Maven))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Maven != null)
                    hashCode = hashCode * 59 + this.Maven.GetHashCode();
                return hashCode;
            }
        }
    }
