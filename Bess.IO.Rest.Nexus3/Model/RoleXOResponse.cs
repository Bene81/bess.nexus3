...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleXOResponse :  IEquatable<RoleXOResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleXOResponse" /> class.
        /// </summary>
        /// <param name="id">The id of the role..</param>
        /// <param name="source">The user source which is the origin of this role..</param>
        ...
        public RoleXOResponse(string id = default(string), string source = default(string), string name = default(string), string description = default(string), List<string> privileges = default(List<string>), List<string> roles = default(List<string>))
        {
            this.Id = id;
            this.Source = source;
            this.Name = name;
        ...
        /// </summary>
        /// <value>The user source which is the origin of this role.</value>
        ...
        {
            return this.Equals(input as RoleXOResponse);
        }

        /// <summary>
        /// Returns true if RoleXOResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleXOResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleXOResponse input)
        {
            if (input == null)
                return false;
