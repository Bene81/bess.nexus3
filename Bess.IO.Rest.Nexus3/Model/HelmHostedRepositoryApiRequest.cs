...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HelmHostedRepositoryApiRequest :  IEquatable<HelmHostedRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HelmHostedRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HelmHostedRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HelmHostedRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public HelmHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for HelmHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for HelmHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for HelmHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as HelmHostedRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if HelmHostedRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HelmHostedRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelmHostedRepositoryApiRequest input)
        {
            if (input == null)
                return false;
