...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HelmProxyRepositoryApiRequest :  IEquatable<HelmProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HelmProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HelmProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HelmProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public HelmProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for HelmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HelmProxyRepositoryApiRequest {\n");
        ...
        {
            return this.Equals(input as HelmProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if HelmProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HelmProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelmProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
