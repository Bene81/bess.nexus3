...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HttpClientAttributes :  IEquatable<HttpClientAttributes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpClientAttributes" /> class.
        /// </summary>
        ...
        public HttpClientAttributes(bool? blocked = default(bool?), bool? autoBlock = default(bool?), HttpClientConnectionAttributes connection = default(HttpClientConnectionAttributes), HttpClientConnectionAuthenticationAttributes authentication = default(HttpClientConnectionAuthenticationAttributes))
        {
            // to ensure "blocked" is required (not null)
            if (blocked == null)
            {
                throw new InvalidDataException("blocked is a required property for HttpClientAttributes and cannot be null");
            }
            else
            {
            ...
            if (autoBlock == null)
            {
                throw new InvalidDataException("autoBlock is a required property for HttpClientAttributes and cannot be null");
            }
            else
            {
        ...
        public HttpClientConnectionAuthenticationAttributes Authentication { get; set; }
        ...
        {
            return this.Equals(input as HttpClientAttributes);
        }

        /// <summary>
        /// Returns true if HttpClientAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of HttpClientAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HttpClientAttributes input)
        {
            if (input == null)
                return false;
