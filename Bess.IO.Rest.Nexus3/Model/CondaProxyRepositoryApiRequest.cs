...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CondaProxyRepositoryApiRequest :  IEquatable<CondaProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CondaProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CondaProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CondaProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public CondaProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string))
        {
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for CondaProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for CondaProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for CondaProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for CondaProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for CondaProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CondaProxyRepositoryApiRequest {\n");
        ...
        {
            return this.Equals(input as CondaProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if CondaProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CondaProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CondaProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
