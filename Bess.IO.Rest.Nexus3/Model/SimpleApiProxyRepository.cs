...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleApiProxyRepository :  IEquatable<SimpleApiProxyRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleApiProxyRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimpleApiProxyRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleApiProxyRepository" /> class.
        /// </summary>
        ...
        public SimpleApiProxyRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for SimpleApiProxyRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for SimpleApiProxyRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for SimpleApiProxyRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for SimpleApiProxyRepository and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SimpleApiProxyRepository);
        }

        /// <summary>
        /// Returns true if SimpleApiProxyRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleApiProxyRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleApiProxyRepository input)
        {
            if (input == null)
                return false;
