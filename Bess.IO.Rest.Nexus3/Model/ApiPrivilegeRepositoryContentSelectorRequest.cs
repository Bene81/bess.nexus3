...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiPrivilegeRepositoryContentSelectorRequest :  IEquatable<ApiPrivilegeRepositoryContentSelectorRequest>
    {
        /// <summary>
        /// Defines Actions
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiPrivilegeRepositoryContentSelectorRequest" /> class.
        /// </summary>
        ...
        /// <param name="contentSelector">The name of a content selector that will be used to grant access to content via this privilege..</param>
        public ApiPrivilegeRepositoryContentSelectorRequest(string name = default(string), string description = default(string), List<ActionsEnum> actions = default(List<ActionsEnum>), string format = default(string), string repository = default(string), string contentSelector = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The name of a content selector that will be used to grant access to content via this privilege.</value>
        ...
        {
            return this.Equals(input as ApiPrivilegeRepositoryContentSelectorRequest);
        }

        /// <summary>
        /// Returns true if ApiPrivilegeRepositoryContentSelectorRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiPrivilegeRepositoryContentSelectorRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiPrivilegeRepositoryContentSelectorRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ContentSelector == input.ContentSelector ||
                    (this.ContentSelector != null &&
                    this.ContentSelector.Equals(input.ContentSelector))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ContentSelector != null)
                    hashCode = hashCode * 59 + this.ContentSelector.GetHashCode();
                return hashCode;
            }
        }
    }
