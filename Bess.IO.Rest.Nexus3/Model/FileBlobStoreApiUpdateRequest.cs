...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FileBlobStoreApiUpdateRequest :  IEquatable<FileBlobStoreApiUpdateRequest>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FileBlobStoreApiUpdateRequest);
        }

        /// <summary>
        /// Returns true if FileBlobStoreApiUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FileBlobStoreApiUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileBlobStoreApiUpdateRequest input)
        {
            if (input == null)
                return false;
