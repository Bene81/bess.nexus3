...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BowerProxyRepositoryApiRequest :  IEquatable<BowerProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BowerProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BowerProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BowerProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public BowerProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string), BowerAttributes bower = default(BowerAttributes))
        {
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for BowerProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for BowerProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for BowerProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for BowerProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for BowerProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        /// Gets or Sets Bower
        /// </summary>
        [DataMember(Name="bower", EmitDefaultValue=false)]
        public BowerAttributes Bower { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Bower: ").Append(Bower).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BowerProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if BowerProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BowerProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BowerProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Bower == input.Bower ||
                    (this.Bower != null &&
                    this.Bower.Equals(input.Bower))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Bower != null)
                    hashCode = hashCode * 59 + this.Bower.GetHashCode();
                return hashCode;
            }
        }
    }
