...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleApiHostedRepository :  IEquatable<SimpleApiHostedRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleApiHostedRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimpleApiHostedRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleApiHostedRepository" /> class.
        /// </summary>
        ...
        public SimpleApiHostedRepository(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes))
        {
            // to ensure "online" is required (not null)
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for SimpleApiHostedRepository and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for SimpleApiHostedRepository and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SimpleApiHostedRepository {\n");
        ...
        {
            return this.Equals(input as SimpleApiHostedRepository);
        }

        /// <summary>
        /// Returns true if SimpleApiHostedRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleApiHostedRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleApiHostedRepository input)
        {
            if (input == null)
                return false;
