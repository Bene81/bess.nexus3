...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RawHostedRepositoryApiRequest :  IEquatable<RawHostedRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawHostedRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RawHostedRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RawHostedRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public RawHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes), RawAttributes raw = default(RawAttributes))
        {
        ...
        public RawAttributes Raw { get; set; }
        ...
        {
            return this.Equals(input as RawHostedRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if RawHostedRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RawHostedRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RawHostedRepositoryApiRequest input)
        {
            if (input == null)
                return false;
