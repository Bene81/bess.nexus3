...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AptProxyRepositoryApiRequest :  IEquatable<AptProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AptProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AptProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AptProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public AptProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string), AptProxyRepositoriesAttributes apt = default(AptProxyRepositoriesAttributes))
        {
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (apt == null)
            {
                throw new InvalidDataException("apt is a required property for AptProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Apt = apt;
        ...
        {
            return this.Equals(input as AptProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if AptProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AptProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AptProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
