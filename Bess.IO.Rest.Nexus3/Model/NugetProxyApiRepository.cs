...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NugetProxyApiRepository :  IEquatable<NugetProxyApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NugetProxyApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NugetProxyApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NugetProxyApiRepository" /> class.
        /// </summary>
        ...
        public NugetProxyApiRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string), NugetAttributes nugetProxy = default(NugetAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for NugetProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for NugetProxyApiRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for NugetProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for NugetProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (nugetProxy == null)
            {
                throw new InvalidDataException("nugetProxy is a required property for NugetProxyApiRepository and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NugetProxyApiRepository);
        }

        /// <summary>
        /// Returns true if NugetProxyApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of NugetProxyApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NugetProxyApiRepository input)
        {
            if (input == null)
                return false;
