...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiPrivilegeRepositoryAdminRequest :  IEquatable<ApiPrivilegeRepositoryAdminRequest>
    {
        /// <summary>
        /// Defines Actions
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiPrivilegeRepositoryAdminRequest" /> class.
        /// </summary>
        ...
        public ApiPrivilegeRepositoryAdminRequest(string name = default(string), string description = default(string), List<ActionsEnum> actions = default(List<ActionsEnum>), string format = default(string), string repository = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ApiPrivilegeRepositoryAdminRequest);
        }

        /// <summary>
        /// Returns true if ApiPrivilegeRepositoryAdminRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiPrivilegeRepositoryAdminRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiPrivilegeRepositoryAdminRequest input)
        {
            if (input == null)
                return false;
