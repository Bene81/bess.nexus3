...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NugetProxyRepositoryApiRequest :  IEquatable<NugetProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NugetProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NugetProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NugetProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        /// <param name="nugetProxy">nugetProxy (required).</param>
        public NugetProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string), NugetAttributes nugetProxy = default(NugetAttributes))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.HttpClient = httpClient;
            }
            // to ensure "nugetProxy" is required (not null)
            if (nugetProxy == null)
            {
                throw new InvalidDataException("nugetProxy is a required property for NugetProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets NugetProxy
        /// </summary>
        [DataMember(Name="nugetProxy", EmitDefaultValue=false)]
        public NugetAttributes NugetProxy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NugetProxy: ").Append(NugetProxy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NugetProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if NugetProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NugetProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NugetProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NugetProxy == input.NugetProxy ||
                    (this.NugetProxy != null &&
                    this.NugetProxy.Equals(input.NugetProxy))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NugetProxy != null)
                    hashCode = hashCode * 59 + this.NugetProxy.GetHashCode();
                return hashCode;
            }
        }
    }
