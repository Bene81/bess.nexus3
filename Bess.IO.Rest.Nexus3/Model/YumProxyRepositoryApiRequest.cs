...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class YumProxyRepositoryApiRequest :  IEquatable<YumProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YumProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected YumProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="YumProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public YumProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string), YumSigningRepositoriesAttributes yumSigning = default(YumSigningRepositoriesAttributes))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for YumProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as YumProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if YumProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of YumProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(YumProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
