...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RawGroupRepositoryApiRequest :  IEquatable<RawGroupRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawGroupRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RawGroupRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RawGroupRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RawGroupRepositoryApiRequest {\n");
        ...
        {
            return this.Equals(input as RawGroupRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if RawGroupRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RawGroupRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RawGroupRepositoryApiRequest input)
        {
            if (input == null)
                return false;
