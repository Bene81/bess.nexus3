...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class YumHostedApiRepository :  IEquatable<YumHostedApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YumHostedApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected YumHostedApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="YumHostedApiRepository" /> class.
        /// </summary>
        ...
        public YumHostedApiRepository(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes), YumAttributes yum = default(YumAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for YumHostedApiRepository and cannot be null");
            }
            else
            {
            ...
            if (yum == null)
            {
                throw new InvalidDataException("yum is a required property for YumHostedApiRepository and cannot be null");
            }
            else
            {
                this.Yum = yum;
        ...
        {
            return this.Equals(input as YumHostedApiRepository);
        }

        /// <summary>
        /// Returns true if YumHostedApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of YumHostedApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(YumHostedApiRepository input)
        {
            if (input == null)
                return false;
