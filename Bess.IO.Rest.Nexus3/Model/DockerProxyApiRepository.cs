...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DockerProxyApiRepository :  IEquatable<DockerProxyApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerProxyApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DockerProxyApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerProxyApiRepository" /> class.
        /// </summary>
        ...
        public DockerProxyApiRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string), DockerAttributes docker = default(DockerAttributes), DockerProxyAttributes dockerProxy = default(DockerProxyAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (docker == null)
            {
                throw new InvalidDataException("docker is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
                this.Docker = docker;
            ...
            if (dockerProxy == null)
            {
                throw new InvalidDataException("dockerProxy is a required property for DockerProxyApiRepository and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets DockerProxy
        /// </summary>
        [DataMember(Name="dockerProxy", EmitDefaultValue=false)]
        public DockerProxyAttributes DockerProxy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DockerProxy: ").Append(DockerProxy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DockerProxyApiRepository);
        }

        /// <summary>
        /// Returns true if DockerProxyApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of DockerProxyApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DockerProxyApiRepository input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DockerProxy == input.DockerProxy ||
                    (this.DockerProxy != null &&
                    this.DockerProxy.Equals(input.DockerProxy))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DockerProxy != null)
                    hashCode = hashCode * 59 + this.DockerProxy.GetHashCode();
                return hashCode;
            }
        }
    }
