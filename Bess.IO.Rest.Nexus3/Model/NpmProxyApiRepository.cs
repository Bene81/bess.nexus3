...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NpmProxyApiRepository :  IEquatable<NpmProxyApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NpmProxyApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NpmProxyApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NpmProxyApiRepository" /> class.
        /// </summary>
        ...
        public NpmProxyApiRepository(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRuleName = default(string), NpmAttributes npm = default(NpmAttributes))
        {
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for NpmProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for NpmProxyApiRepository and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for NpmProxyApiRepository and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for NpmProxyApiRepository and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NpmProxyApiRepository);
        }

        /// <summary>
        /// Returns true if NpmProxyApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of NpmProxyApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NpmProxyApiRepository input)
        {
            if (input == null)
                return false;
