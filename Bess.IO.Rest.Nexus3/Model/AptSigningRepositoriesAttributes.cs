...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AptSigningRepositoriesAttributes :  IEquatable<AptSigningRepositoriesAttributes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AptSigningRepositoriesAttributes" /> class.
        /// </summary>
        ...
        public AptSigningRepositoriesAttributes(string keypair = default(string), string passphrase = default(string))
        {
        ...
        {
            return this.Equals(input as AptSigningRepositoriesAttributes);
        }

        /// <summary>
        /// Returns true if AptSigningRepositoriesAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AptSigningRepositoriesAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AptSigningRepositoriesAttributes input)
        {
            if (input == null)
                return false;
