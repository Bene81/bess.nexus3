...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DockerHostedApiRepository :  IEquatable<DockerHostedApiRepository>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerHostedApiRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DockerHostedApiRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerHostedApiRepository" /> class.
        /// </summary>
        ...
        public DockerHostedApiRepository(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes), DockerAttributes docker = default(DockerAttributes))
        {
            // to ensure "online" is required (not null)
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for DockerHostedApiRepository and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for DockerHostedApiRepository and cannot be null");
            }
            else
            {
            ...
            if (docker == null)
            {
                throw new InvalidDataException("docker is a required property for DockerHostedApiRepository and cannot be null");
            }
            else
            {
                this.Docker = docker;
        ...
        {
            return this.Equals(input as DockerHostedApiRepository);
        }

        /// <summary>
        /// Returns true if DockerHostedApiRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of DockerHostedApiRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DockerHostedApiRepository input)
        {
            if (input == null)
                return false;
