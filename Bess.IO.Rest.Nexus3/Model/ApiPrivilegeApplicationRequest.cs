...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiPrivilegeApplicationRequest :  IEquatable<ApiPrivilegeApplicationRequest>
    {
        /// <summary>
        /// Defines Actions
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiPrivilegeApplicationRequest" /> class.
        /// </summary>
        ...
        /// <param name="domain">The domain (i.e. &#39;blobstores&#39;, &#39;capabilities&#39; or even &#39;*&#39; for all) that this privilege is granting access to.  Note that creating new privileges with a domain is only necessary when using plugins that define their own domain(s)..</param>
        public ApiPrivilegeApplicationRequest(string name = default(string), string description = default(string), List<ActionsEnum> actions = default(List<ActionsEnum>), string domain = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The domain (i.e. &#39;blobstores&#39;, &#39;capabilities&#39; or even &#39;*&#39; for all) that this privilege is granting access to.  Note that creating new privileges with a domain is only necessary when using plugins that define their own domain(s).</value>
        ...
        {
            return this.Equals(input as ApiPrivilegeApplicationRequest);
        }

        /// <summary>
        /// Returns true if ApiPrivilegeApplicationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiPrivilegeApplicationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiPrivilegeApplicationRequest input)
        {
            if (input == null)
                return false;
