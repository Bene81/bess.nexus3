...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RProxyRepositoryApiRequest :  IEquatable<RProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public RProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string))
        {
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for RProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for RProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for RProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for RProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for RProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if RProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
