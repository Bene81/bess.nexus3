...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DockerGroupRepositoryApiRequest :  IEquatable<DockerGroupRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerGroupRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DockerGroupRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DockerGroupRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public DockerGroupRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), GroupDeployAttributes group = default(GroupDeployAttributes), DockerAttributes docker = default(DockerAttributes))
        {
        ...
        {
            return this.Equals(input as DockerGroupRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if DockerGroupRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DockerGroupRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DockerGroupRepositoryApiRequest input)
        {
            if (input == null)
                return false;
