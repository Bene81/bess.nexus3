...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RawProxyRepositoryApiRequest :  IEquatable<RawProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RawProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RawProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RawProxyRepositoryApiRequest {\n");
        ...
        {
            return this.Equals(input as RawProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if RawProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RawProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RawProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
