...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RubyGemsHostedRepositoryApiRequest :  IEquatable<RubyGemsHostedRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RubyGemsHostedRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RubyGemsHostedRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RubyGemsHostedRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public RubyGemsHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ComponentAttributes component = default(ComponentAttributes))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RubyGemsHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for RubyGemsHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for RubyGemsHostedRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RubyGemsHostedRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if RubyGemsHostedRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RubyGemsHostedRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RubyGemsHostedRepositoryApiRequest input)
        {
            if (input == null)
                return false;
