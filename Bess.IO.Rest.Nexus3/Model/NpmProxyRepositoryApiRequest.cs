...
namespace Bess.IO.Rest.Nexus3.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NpmProxyRepositoryApiRequest :  IEquatable<NpmProxyRepositoryApiRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NpmProxyRepositoryApiRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NpmProxyRepositoryApiRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NpmProxyRepositoryApiRequest" /> class.
        /// </summary>
        ...
        public NpmProxyRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes), ProxyAttributes proxy = default(ProxyAttributes), NegativeCacheAttributes negativeCache = default(NegativeCacheAttributes), HttpClientAttributes httpClient = default(HttpClientAttributes), string routingRule = default(string), NpmAttributes npm = default(NpmAttributes))
        {
            ...
            if (online == null)
            {
                throw new InvalidDataException("online is a required property for NpmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Online = online;
            ...
            if (storage == null)
            {
                throw new InvalidDataException("storage is a required property for NpmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (proxy == null)
            {
                throw new InvalidDataException("proxy is a required property for NpmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
                this.Proxy = proxy;
            ...
            {
                throw new InvalidDataException("negativeCache is a required property for NpmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
            ...
            if (httpClient == null)
            {
                throw new InvalidDataException("httpClient is a required property for NpmProxyRepositoryApiRequest and cannot be null");
            }
            else
            {
        ...
        public NpmAttributes Npm { get; set; }
        ...
        {
            return this.Equals(input as NpmProxyRepositoryApiRequest);
        }

        /// <summary>
        /// Returns true if NpmProxyRepositoryApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NpmProxyRepositoryApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NpmProxyRepositoryApiRequest input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Npm != null)
                    hashCode = hashCode * 59 + this.Npm.GetHashCode();
                return hashCode;
            }
        }
    }
